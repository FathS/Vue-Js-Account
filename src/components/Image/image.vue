...
.perde {
  ...
  border: none;
  box-shadow: 0px 0px 20px 4px #7e7e7e;
  margin-right: 10px;
}
.header {
  position: relative;
  ...
  background-image: linear-gradient(
      to right bottom rgba(119, 148, 114, 0.7),
      rgba(85, 88, 88, 0.7)
    ),
    url("../../assets/images/login_back.jpg");
...
@keyframes moveInLeft {
  ...
  100% {
    opacity: 1;
    transform: translate(0) rotate(360deg) scale(2);
  }
}
